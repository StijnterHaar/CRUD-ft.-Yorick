    ...
    <div class="top-box">
        <div class="box-container">
            <div class="contactform">
                <h2>Wie zijn wij</h2>
                <p>Deze website is opgebouwd door Stijn en Yorick van ROC nijmegen. Wij zijn 2 software developers die momenteel in het eerste jaar zitten
                    van de opleiding en hebben hier ongeveer 3 weken aan gewerkt.
                </p>
                <h2>Wat doen wij</h2>
                <p>Op onze website kunt u vakanties boeken etc</p>
                <h2>Opbouw</h2>
